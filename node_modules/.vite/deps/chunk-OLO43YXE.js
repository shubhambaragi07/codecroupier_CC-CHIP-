...
async function recoverPublicKey({ hash: hash2, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-HS6PWR6G.js");
  const signature_ = (() => {
...
function fromRlpCursor(cursor, to2 = "hex", recursiveDepth = 0) {
  ...
  return readList(cursor, length, to2, recursiveDepth + 1);
}
...
function readList(cursor, length, to2, recursiveDepth) {
  const position = cursor.position;
  const value = [];
  while (cursor.position - position < length)
    value.push(fromRlpCursor(cursor, to2, recursiveDepth));
...
var InvalidYParityError2 = class extends BaseError2 {
  constructor({ value }) {
...
async function getWebSocketRpcClient(url, options = {}) {
  ...
  return getSocketRpcClient({
    async getSocket({ onClose, onError, onOpen, onResponse }) {
      const WebSocket = await import("./native-DHRP7WUH.js").then((module) => module.WebSocket);
...
//# sourceMappingURL=chunk-OLO43YXE.js.map
