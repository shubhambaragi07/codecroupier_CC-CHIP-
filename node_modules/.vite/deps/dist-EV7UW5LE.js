...
var require_assert = __commonJS({
  "node_modules/@noble/hashes/_assert.js"(exports) {
    ...
    var assert7 = { number, bool, bytes: bytes2, hash: hash2, exists: exists2, output: output2 };
...
var require_u64 = __commonJS({
  "node_modules/@noble/hashes/_u64.js"(exports) {
    ...
    var rotr32L2 = (h3, _l) => h3;
    exports.rotr32L = rotr32L2;
    var rotlSH2 = (h3, l3, s3) => h3 << s3 | l3 >>> 32 - s3;
    exports.rotlSH = rotlSH2;
    var rotlSL2 = (h3, l3, s3) => l3 << s3 | h3 >>> 32 - s3;
    exports.rotlSL = rotlSL2;
    var rotlBH2 = (h3, l3, s3) => l3 << s3 - 32 | h3 >>> 64 - s3;
    exports.rotlBH = rotlBH2;
    var rotlBL2 = (h3, l3, s3) => h3 << s3 - 32 | l3 >>> 64 - s3;
...
var require_utils = __commonJS({
  "node_modules/@noble/hashes/utils.js"(exports) {
    ...
    var hexes6 = Array.from({ length: 256 }, (_2, i3) => i3.toString(16).padStart(2, "0"));
    function bytesToHex4(bytes2) {
      (0, _assert_js_1.bytes)(bytes2);
      let hex = "";
      for (let i3 = 0; i3 < bytes2.length; i3++) {
        hex += hexes6[bytes2[i3]];
      }
      return hex;
    }
...
var require_sha3 = __commonJS({
  "node_modules/@noble/hashes/sha3.js"(exports) {
    ...
    for (let round = 0, R = _1n10, x2 = 1, y3 = 0; round < 24; round++) {
      [x2, y3] = [y3, (2 * x2 + 3 * y3) % 5];
      SHA3_PI2.push(2 * (5 * y3 + x2));
      SHA3_ROTL2.push((round + 1) * (round + 2) / 2 % 64);
      let t3 = _0n10;
      for (let j3 = 0; j3 < 7; j3++) {
        R = (R << _1n10 ^ (R >> _7n2) * _0x71n2) % _256n2;
        if (R & _2n9)
          t3 ^= _1n10 << (_1n10 << BigInt(j3)) - _1n10;
      }
      _SHA3_IOTA2.push(t3);
    }
    var [SHA3_IOTA_H2, SHA3_IOTA_L2] = (0, _u64_js_1.split)(_SHA3_IOTA2, true);
    var rotlH2 = (h3, l3, s3) => s3 > 32 ? (0, _u64_js_1.rotlBH)(h3, l3, s3) : (0, _u64_js_1.rotlSH)(h3, l3, s3);
    var rotlL2 = (h3, l3, s3) => s3 > 32 ? (0, _u64_js_1.rotlBL)(h3, l3, s3) : (0, _u64_js_1.rotlSL)(h3, l3, s3);
...
var require_util = __commonJS({
  "node_modules/@coinbase/wallet-sdk/dist/vendor-js/eth-eip712-util/util.cjs"(exports, module) {
    ...
    function keccak(a3, bits) {
      ...
      return Buffer.from(keccak_2562(new Uint8Array(a3)));
    }
  ...
  "node_modules/@coinbase/wallet-sdk/dist/vendor-js/eth-eip712-util/abi.cjs"(exports, module) {
    ...
    function encodeSingle(type, arg) {
      ...
      if (type === "address") {
        ...
        size5 = parseTypeNxM(type);
        num2 = parseNumber(arg);
        if (num2 < 0) {
          throw new Error("Supplied ufixed is negative");
        }
        return encodeSingle("uint256", num2 * BigInt(2) ** BigInt(size5[1]));
    ...
    function rawEncode(types2, values) {
      ...
      for (var i3 in types2) {
        var type = elementaryName(types2[i3]);
        var value = values[i3];
    ...
    function solidityPack(types2, values) {
      ...
      for (var i3 = 0; i3 < types2.length; i3++) {
        ...
        if (type === "bytes") {
          ...
          ret.push(util.bufferBEFromBigInt(num2, size5 / 8));
        } else if (type.startsWith("int")) {
          size5 = parseTypeN(type);
          if (size5 % 8 || size5 < 8 || size5 > 256) {
            throw new Error("Invalid int<N> width: " + size5);
          ...
          const twos = util.twosFromBigInt(num2, size5);
...
var require_eth_eip712_util = __commonJS({
  "node_modules/@coinbase/wallet-sdk/dist/vendor-js/eth-eip712-util/index.cjs"(exports, module) {
    ...
    function typedSignatureHashLegacy(typedData) {
      ...
      const types2 = typedData.map(function(e3) {
        return e3.type;
      });
...
function setBigUint64(view, byteOffset, value, isLE4) {
  ...
  const h3 = isLE4 ? 4 : 0;
  const l3 = isLE4 ? 0 : 4;
  view.setUint32(byteOffset + h3, wh, isLE4);
  view.setUint32(byteOffset + l3, wl, isLE4);
}
...
var SHA1 = class extends HashMD {
  ...
  process(view, offset) {
    ...
    for (let i3 = 0; i3 < 80; i3++) {
      ...
      const T2 = rotl(A2, 5) + F2 + E + K2 + SHA1_W[i3] | 0;
      E = D2;
      D2 = C3;
      C3 = rotl(B3, 30);
      B3 = A2;
...
function assertSize(bytes2, size_) {
  if (size3(bytes2) > size_)
    throw new SizeOverflowError({
      givenSize: size3(bytes2),
      maxSize: size_
    });
}
...
function pad2(bytes2, options = {}) {
  ...
  for (let i3 = 0; i3 < size5; i3++) {
    ...
    paddedBytes[padEnd ? i3 : size5 - i3 - 1] = bytes2[padEnd ? i3 : bytes2.length - i3 - 1];
  }
  return paddedBytes;
}
...
function toBytes3(publicKey, options = {}) {
  return fromHex2(toHex4(publicKey, options));
}
...
function checksum2(address) {
  ...
  const hash2 = keccak2563(fromString2(hexAddress), { as: "Bytes" });
...
function getSignatureHash(abiItem) {
  if (typeof abiItem !== "string" && "hash" in abiItem && abiItem.hash)
    return abiItem.hash;
  return keccak2563(fromString(getSignature(abiItem)));
}
...
var hexes4 = Array.from({ length: 256 }, (_2, i3) => i3.toString(16).padStart(2, "0"));
...
var Chi2 = (a3, b2, c3) => a3 & b2 ^ ~a3 & c3;
var Maj2 = (a3, b2, c3) => a3 & b2 ^ a3 & c3 ^ b2 & c3;
...
var SHA2562 = class extends HashMD2 {
  ...
  process(view, offset) {
    ...
    for (let i3 = 0; i3 < 64; i3++) {
      ...
      const T1 = H + sigma1 + Chi2(E, F2, G) + SHA256_K2[i3] + SHA256_W2[i3] | 0;
      const sigma0 = rotr2(A2, 2) ^ rotr2(A2, 13) ^ rotr2(A2, 22);
      const T2 = sigma0 + Maj2(A2, B3, C3) | 0;
      H = G;
      G = F2;
      F2 = E;
      E = D2 + T1 | 0;
...
function invert(number, modulo) {
  ...
  let b2 = modulo;
  let x2 = _0n3, y3 = _1n3, u3 = _1n3, v3 = _0n3;
  while (a3 !== _0n3) {
    const q2 = b2 / a3;
    const r4 = b2 % a3;
    const m2 = x2 - u3 * q2;
    const n2 = y3 - v3 * q2;
    b2 = a3, a3 = r4, x2 = u3, y3 = v3, u3 = m2, v3 = n2;
  }
  const gcd = b2;
  if (gcd !== _1n3)
...
function tonelliShanks(P2) {
  ...
  let Q, S2, Z;
  for (Q = P2 - _1n3, S2 = 0; Q % _2n3 === _0n3; Q /= _2n3, S2++)
    ;
  ...
  return function tonelliSlow(Fp3, n2) {
    ...
    while (!Fp3.eql(b2, Fp3.ONE)) {
      if (Fp3.eql(b2, Fp3.ZERO))
        return Fp3.ZERO;
      let m2 = 1;
      for (let t22 = Fp3.sqr(b2); m2 < r4; m2++) {
        if (Fp3.eql(t22, Fp3.ONE))
          break;
        t22 = Fp3.sqr(t22);
      }
      const ge = Fp3.pow(g2, _1n3 << BigInt(r4 - m2 - 1));
      g2 = Fp3.sqr(ge);
      x2 = Fp3.mul(x2, ge);
      b2 = Fp3.mul(b2, g2);
      r4 = m2;
...
function FpLegendre(order) {
  ...
  return (f3, x2) => f3.pow(x2, legendreConst);
}
...
function wNAF(c3, bits) {
  return {
     ...
     * @returns point
     */
    wNAFUnsafe(W, precomputes, n2, acc = c3.ZERO) {
      const { windows, windowSize } = calcWOpts(W, bits);
      const mask = BigInt(2 ** W - 1);
      const maxNumber = 2 ** W;
      const shiftBy = BigInt(W);
...
function weierstrassPoints(opts) {
  ...
  const toBytes8 = CURVE.toBytes || ((_c, point, _isCompressed) => {
    ...
    return concatBytes(Uint8Array.from([4]), Fp3.toBytes(a3.x), Fp3.toBytes(a3.y));
  });
  const fromBytes6 = CURVE.fromBytes || ((bytes2) => {
  ...
  const toAffineMemo = memoized((p3, iz) => {
    const { px: x2, py: y3, pz: z3 } = p3;
    if (Fp3.eql(z3, Fp3.ONE))
      return { x: x2, y: y3 };
    const is0 = p3.is0();
    if (iz == null)
  ...
  const assertValidMemo = memoized((p3) => {
    if (p3.is0()) {
      if (CURVE.allowInfinityPoint && !Fp3.is0(p3.py))
        return;
  ...
  class Point2 {
    ...
    static fromAffine(p3) {
      ...
      if (is0(x2) && is0(y3))
        return Point2.ZERO;
      return new Point2(x2, y3, Fp3.ONE);
    }
    get x() {
     ...
     */
    static fromHex(hex) {
      const P2 = Point2.fromAffine(fromBytes6(ensureBytes("pointHex", hex)));
      P2.assertValidity();
      return P2;
    }
    ...
    multiply(scalar) {
      ...
      if (endo) {
        ...
        const { p: p3, f: f3 } = this.wNAF(scalar);
        point = p3;
        fake = f3;
      }
...
function weierstrass(curveDef) {
  ...
  const slcNum = (b2, from10, to) => bytesToNumberBE(b2.slice(from10, to));
  class Signature {
    constructor(r4, s3, recovery) {
      this.r = r4;
      this.s = s3;
    ...
    static fromDER(hex) {
      const { r: r4, s: s3 } = DER.toSig(ensureBytes("DER", hex));
    ...
    recoverPublicKey(msgHash) {
      const { r: r4, s: s3, recovery: rec } = this;
  ...
  function prepSig(msgHash, privateKey, opts = defaultSigOpts) {
    ...
    function k2sig(kBytes) {
      ...
      if (r4 === _0n5)
        return;
      const s3 = modN2(ik * modN2(m2 + r4 * d3));
      if (s3 === _0n5)
        return;
      let recovery = (q2.x === r4 ? 0 : 2) | Number(q2.y & _1n5);
      let normS = s3;
  ...
  function verify4(signature, msgHash, publicKey, opts = defaultVerOpts) {
    ...
    const { r: r4, s: s3 } = _sig;
    const h3 = bits2int_modN(msgHash);
    const is = invN(s3);
    const u1 = modN2(h3 * is);
    const u22 = modN2(r4 * is);
    const R = Point2.BASE.multiplyAndAddUnsafe(P2, u1, u22)?.toAffine();
    if (!R)
      return false;
    const v3 = modN2(R.x);
    return v3 === r4;
...
function SWUFpSqrtRatio(Fp3, Z) {
  ...
  const c7 = Fp3.pow(Z, (c22 + _1n5) / _2n4);
  let sqrtRatio = (u3, v3) => {
    let tv1 = c6;
...
function hash_to_field(msg, count, options) {
  ...
  const { p: p3, k: k3, m: m2, hash: hash2, expand, DST: _DST } = options;
  abytes2(msg);
  anum(count);
...
function isogenyMap(field, map) {
  ...
  return (x2, y3) => {
    const [xNum, xDen, yNum, yDen] = COEFF.map((val) => val.reduce((acc, i3) => field.add(field.mul(acc, x2), i3)));
...
function createHasher2(Point2, mapToCurve, def) {
  ...
  return {
    ...
    encodeToCurve(msg, options) {
      ...
      const P2 = Point2.fromAffine(mapToCurve(u3[0])).clearCofactor();
      P2.assertValidity();
      return P2;
    },
...
var _1n6 = BigInt(1);
var _2n5 = BigInt(2);
var divNearest = (a3, b2) => (a3 + b2 / _2n5) / b2;
function sqrtMod(y3) {
  const P2 = secp256k1P;
...
function taggedHash(tag, ...messages) {
  ...
  if (tagP === void 0) {
    const tagH = sha2564(Uint8Array.from(tag, (c3) => c3.charCodeAt(0)));
...
var modP = (x2) => mod(x2, secp256k1P);
var modN = (x2) => mod(x2, secp256k1N);
...
function schnorrSign(message, privateKey, auxRand = randomBytes(32)) {
  ...
  const t3 = numTo32b(d3 ^ num(taggedHash("BIP0340/aux", a3)));
  ...
  sig.set(rx, 0);
  sig.set(numTo32b(modN(k3 + e3 * d3)), 32);
...
function schnorrVerify(signature, message, publicKey) {
  ...
  try {
    ...
    if (!inRange(r4, _1n6, secp256k1P))
      return false;
    const s3 = num(sig.subarray(32, 64));
    if (!inRange(s3, _1n6, secp256k1N))
      return false;
    const e3 = challenge(numTo32b(r4), pointToBytes(P2), m2);
    const R = GmulAdd(P2, s3, modN(-e3));
    if (!R || !R.hasEvenY() || R.toAffine().x !== r4)
      return false;
    return true;
  } catch (error) {
    return false;
...
var htf = (() => createHasher2(secp256k1.ProjectivePoint, (scalars) => {
...
function fromDerHex(signature) {
  const { r: r4, s: s3 } = secp256k1.Signature.fromDER(from2(signature).slice(2));
  return { r: r4, s: s3 };
}
...
function bls(CURVE) {
  ...
  function aggregateSignatures(signatures) {
    ...
    const agg = signatures.map(normP2).reduce((sum, s3) => sum.add(s3), G2.ProjectivePoint.ZERO);
    const aggAffine = agg;
  ...
  function aggregateShortSignatures(signatures) {
    aNonEmpty(signatures);
    const agg = signatures.map(normP1).reduce((sum, s3) => sum.add(s3), G1.ProjectivePoint.ZERO);
    const aggAffine = agg;
...
function psiFrobenius(Fp3, Fp22, base) {
  ...
  const PSI_Y = Fp22.pow(base, (Fp3.ORDER - _1n8) / _2n7);
  function psi(x2, y3) {
    const x22 = Fp22.mul(Fp22.frobeniusMap(x2, 1), PSI_X);
    const y22 = Fp22.mul(Fp22.frobeniusMap(y3, 1), PSI_Y);
    return [x22, y22];
  }
  const PSI2_X = Fp22.pow(base, (Fp3.ORDER ** _2n7 - _1n8) / _3n4);
  const PSI2_Y = Fp22.pow(base, (Fp3.ORDER ** _2n7 - _1n8) / _2n7);
...
function tower12(opts) {
  ...
  const Fp22 = {
    ...
    sqrt: (num2) => {
      ...
      let d3 = Fp3.mul(Fp3.add(a3, c0), Fpdiv2);
      const legendre = FpLegendre2(Fp3, d3);
  ...
  const Fp6Square = ({ c0, c1, c2: c22 }) => {
    ...
    let t3 = Fp22.mul(Fp22.mul(c1, c22), _2n7);
    let t4 = Fp22.sqr(c22);
    return {
...
var bls12_381 = bls({
    ...
    toBytes: (c3, point, isCompressed) => {
      ...
      if (isCompressed) {
        ...
        if (isZero) {
          ...
          return concatBytes(numberToBytesBE(x2, Fp.BYTES), numberToBytesBE(y3, Fp.BYTES));
        }
      }
    },
    ShortSignature: {
      fromHex(hex) {
        ...
        if (y3 * _2n8 / P2 !== aflag)
          y3 = Fp.neg(y3);
        const point = bls12_381.G1.ProjectivePoint.fromAffine({ x: x2, y: y3 });
        point.assertValidity();
        return point;
      },
      toRawBytes(point) {
  ...
  G2: {
    ...
    fromBytes: (bytes2) => {
      ...
      const L2 = Fp.BYTES;
      const slc = (b2, from10, to) => bytesToNumberBE(b2.slice(from10, to));
      if (value.length === 96 && compressed) {
        ...
        const Y_bit = y3.c1 === _0n9 ? y3.c0 * _2n8 / P2 : y3.c1 * _2n8 / P2 ? _1n9 : _0n9;
    ...
    toBytes: (c3, point, isCompressed) => {
      ...
      if (isCompressed) {
        if (isZero)
          return concatBytes(COMPRESSED_ZERO, numberToBytesBE(_0n9, len));
        const flag = Boolean(y3.c1 === _0n9 ? y3.c0 * _2n8 / P2 : y3.c1 * _2n8 / P2);
    ...
    Signature: {
      ...
      fromHex(hex) {
        ...
        const isGreater = y1 > _0n9 && y1 * _2n8 / P2 !== aflag1;
        const isZero = y1 === _0n9 && y0 * _2n8 / P2 !== aflag1;
        if (isGreater || isZero)
          y3 = Fp2.neg(y3);
...
var htf2 = (() => createHasher2(secp256r1.ProjectivePoint, (scalars) => mapSWU2(scalars[0]), {
...
function verify(options) {
  ...
  return secp256r1.verify(signature, payload instanceof Uint8Array ? payload : fromHex2(payload), toHex4(publicKey).substring(2), ...hash2 ? [{ prehash: true, lowS: true }] : []);
}
...
function parseAsn1Signature(bytes2) {
  ...
  const r4 = BigInt(fromBytes(bytes2.slice(r_start, r_end)));
  const s3 = BigInt(fromBytes(bytes2.slice(s_start)));
  return {
    r: r4,
    s: s3 > p256.CURVE.n / 2n ? p256.CURVE.n - s3 : s3
  };
}
...
function getCredentialCreationOptions(options) {
  ...
  return {
    publicKey: {
      ...
      rp,
      user: {
        id: user?.id ?? keccak2563(fromString2(name), { as: "Bytes" }),
        name,
...
async function verify3(options) {
  ...
  return await globalThis.crypto.subtle.verify({
    name: "ECDSA",
    hash: "SHA-256"
  }, publicKey, concat4(fromNumber3(signature.r), fromNumber3(signature.s)), from3(payload));
}
...
async function getAccount() {
  ...
  return {
    ...
    async signMessage({ message }) {
      return sign5(hashMessage(message));
    },
    async signTypedData(parameters) {
      return sign5(hashTypedData(parameters));
    },
    type: "webAuthn"
  };
}
...
function createWalletSendCallsRequest({ calls, from: from10, chainId, capabilities }) {
...
async function createSmartAccount(parameters) {
  ...
  return toSmartAccount({
    ...
    async sign(parameters2) {
      ...
      const signature = await sign4({ hash: hash2, owner });
      return wrapSignature({
        ownerIndex,
        signature
      });
...
async function sign4({ hash: hash2, owner }) {
  if (owner.type === "webAuthn") {
...
var hexes5 = Array.from({ length: 256 }, (_2, i3) => i3.toString(16).padStart(2, "0"));
function bytesToHex3(bytes2) {
  bytes(bytes2);
  let hex = "";
  for (let i3 = 0; i3 < bytes2.length; i3++) {
    hex += hexes5[bytes2[i3]];
  }
  return hex;
}
...
var Chi3 = (a3, b2, c3) => a3 & b2 ^ ~a3 & c3;
var Maj3 = (a3, b2, c3) => a3 & b2 ^ a3 & c3 ^ b2 & c3;
...
var SHA2563 = class extends HashMD3 {
  ...
  process(view, offset) {
    ...
    for (let i3 = 0; i3 < 64; i3++) {
      ...
      const T1 = H + sigma1 + Chi3(E, F2, G) + SHA256_K3[i3] + SHA256_W3[i3] | 0;
      const sigma0 = rotr3(A2, 2) ^ rotr3(A2, 13) ^ rotr3(A2, 22);
      const T2 = sigma0 + Maj3(A2, B3, C3) | 0;
      H = G;
      G = F2;
      F2 = E;
      E = D2 + T1 | 0;
...
var sha2565 = wrapConstructor2(() => new SHA2563());
var sha2243 = wrapConstructor2(() => new SHA2243());
...
var WalletLinkSession = class _WalletLinkSession {
  constructor(storage3, id, secret, linked = false) {
    ...
    this.id = id;
    this.secret = secret;
    this.key = bytesToHex3(sha2565(`${id}, ${secret} WalletLink`));
    this._linked = !!linked;
  }
...
//# sourceMappingURL=dist-EV7UW5LE.js.map
